...
public class ClassGetSet_isLetterIncludedIgnoreCase_char_Negative  {

	private static ClassGetSet cut;
	private char fInput;
	private static String wifeName = "Marzenka";
	
	public ClassGetSet_isLetterIncludedIgnoreCase_char_Negative(char input) {
		fInput = input;
	}
	...
	public void testIsLetterIncludedIgnoreCase_char() {
		assertFalse(String.valueOf(fInput) + " is NOT in " + wifeName, cut.isLetterIncludedIgnoreCase(fInput));
	}
